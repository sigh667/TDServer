...
public:
	void	zero()												{	x = y = 0;									}
	void	set	(int8 _x,int8 _y)								{	x=_x;y=_y;									}

public:
	//比较运算符
	inline bool	operator==(const _stPoint2I8&_test) const		{	return (x == _test.x) && (y == _test.y);	}
	inline bool	operator!=(const _stPoint2I8&_test) const		{	return (x != _test.x) || (y != _test.y);	}
public:
	inline _stPoint2I8&operator= (const _stPoint2F&_point);
	inline _stPoint2I8&operator= (const _stPoint2I&_point);
	inline _stPoint2I8&operator= (const _stPoint2I8&_point);
	inline _stPoint2I8&operator= (const _stPoint2I16&_point);
};
//------------------------------------------------------
//------------------------------ 2F点结构
struct _stPoint2F
...
//-------------------------------------------------------------
//------------------------------ 
inline _stPoint2I8&_stPoint2I8::operator= (const _stPoint2F&_point)		{	set(int8(_point.x),int8(_point.y));			return *this;	}
inline _stPoint2I8&_stPoint2I8::operator= (const _stPoint2I&_point)		{	set(int8(_point.x),int8(_point.y));			return *this;	}
inline _stPoint2I8&_stPoint2I8::operator= (const _stPoint2I8&_point)	{	set(int8(_point.x),int8(_point.y));			return *this;	}
inline _stPoint2I8&_stPoint2I8::operator= (const _stPoint2I16&_point)	{	set(int8(_point.x),int8(_point.y));			return *this;	}
//-------------------------------------------------------------
//------------------------------ 
